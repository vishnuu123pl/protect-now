...
from .. import Bot, bot
from .. import MONGODB_CONNECTION_STRING, OWNER_ID, LOG_GROUP
        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg', 'ts', 'avi', 'flv', 'org']:
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[Alone Boy](https://t.me/aloneboy859)**__" if msg.caption else "__Unrestricted by **[Alone Boy](https://t.me/aloneboy859)**__"
                await send_document_with_chat_id(client, sender, path, caption, thumb_path, upm)
            os.remove(file)
            await upm.delete()
            return None
